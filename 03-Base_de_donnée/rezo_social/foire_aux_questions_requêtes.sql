...
/* Avec jointure */
SELECT question_date, question_label, question_response, users.user_id, users.user_lastname, users.user_firstname 
FROM questions INNER
...
SELECT questions.*, users.user_lastname, users.user_firstname
FROM questions NATURAL
JOIN users 
